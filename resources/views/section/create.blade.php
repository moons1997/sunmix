...
{{--                                                <option value="0">Section type</option>--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="order" type="text" class="form-control" id="order" placeholder="Enter order">
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="ru-tab" style="padding-top: 25px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name_ru" type="text" class="form-control" id="name_ru" placeholder="Enter name">
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="de" role="tabpanel" aria-labelledby="de-tab" style="padding-top: 25px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name_de" type="text" class="form-control" id="name_de" placeholder="Enter name">
                                        </div>

                                        <div class="form-group">
                                            <label for="info_de">Section info</label>
                                            <textarea name="info_de" style="min-height: 500px" class="form-control" id="info_de" placeholder="Enter text">
                                            </textarea>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="es" role="tabpanel" aria-labelledby="es-tab" style="padding-top: 25px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name_es" type="text" class="form-control" id="name_es" placeholder="Enter name">
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="it" role="tabpanel" aria-labelledby="it-tab" style="padding-top: 25px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name_it" type="text" class="form-control" id="name_it" placeholder="Enter name">
                                        </div>
